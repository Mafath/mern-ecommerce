...
import { motion } from "framer-motion"; //for the animations
...
const SignupPage = () => {
  ...
  const handleSubmit = (e) => {
		...
		signup(formData);  // calls the signup function from the Zustand store
	};
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input id='name' type='text' placeholder='Kevin Smith' required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })}
            ...
            <div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input id='email' type='email' placeholder='kevin@gmail.com' required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })}
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm'/>
							</div>
						</div>
